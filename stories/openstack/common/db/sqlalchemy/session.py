...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/stories/sqlite.db",
        sqlite_db="/var/lib/stories/sqlite.db")
...
from stories.openstack.common import log as logging
from stories.openstack.common import timeutils

sqlite_db_opts = [
    cfg.StrOpt('sqlite_db',
               default='stories.sqlite',
    ...
    def _do_query(self, q):
        ...
        for filename, line, method, function in traceback.extract_stack():
            ...
            if filename.endswith('db/api.py'):
                continue
            # only trace inside stories
            index = filename.rfind('stories')
            if index == -1:
                continue
